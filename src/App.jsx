...
import CRMLeadsList from './pages/CRM/LeadsList';
...
import ConfirmedClients from './pages/CRM/ConfirmedClients';
import Dashboard from './pages/Dashboard/Dashboard';
import TeamManager from './pages/BranchManagement/Team/TeamManager';
import BranchManager from './pages/BranchManagement/Branches/BranchManager';
      ...
      <NotificationProvider>
        ...
        <Routes>
          ...
          <Route path="/" element={
            ...
            {/* CRM Routes */}
            <Route path="crm/leads" element={<ProtectedRoute allowedRoles={['SUPER_ADMIN', 'ADMIN', 'BRANCH_MANAGER', 'SALES_EXECUTIVE', 'SALES']}><CRMLeadsList /></ProtectedRoute>} />
            ...
            <Route path="crm/confirmed-queries" element={<ProtectedRoute allowedRoles={['SUPER_ADMIN', 'ADMIN', 'BRANCH_MANAGER', 'SALES_EXECUTIVE', 'SALES']}><ConfirmedClients /></ProtectedRoute>} />
